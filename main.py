...
# Function to download the Spexo-Sheet CSV file
def download_required_csv():
    # Define the content based on the provided Spexo-Sheet
    required_data = [
        [
            "Project ID", "Part Name", "Stock", "Project Permalink",
            "Author", "Part Number", "Part Name", "Quantity", "Part Permalink"
        ]
    ]

    # Open a "Save As" dialog for the user to choose the download location and filename
    ...
    # Write the header data to the selected file
    try:
